...
import com.example.order_service.exception.ApiErrorResponse;
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http, ObjectMapper objectMapper) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/orders/**").hasAnyAuthority(READ_AUTHORITIES)
                        .requestMatchers(HttpMethod.POST, "/api/orders/**").hasAnyAuthority(WRITE_AUTHORITIES)
                        .requestMatchers(HttpMethod.DELETE, "/api/orders/**").hasAnyAuthority(WRITE_AUTHORITIES)
