...
import com.example.user_service.exception.ApiErrorResponse;
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http, ObjectMapper objectMapper) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/users/**").hasAnyAuthority(READ_AUTHORITIES)
                        .requestMatchers(HttpMethod.POST, "/api/users/me").denyAll()
                        .requestMatchers(HttpMethod.POST, "/api/users/**").hasAnyAuthority(WRITE_AUTHORITIES)
