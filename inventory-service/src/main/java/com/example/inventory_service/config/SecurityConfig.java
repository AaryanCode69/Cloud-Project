    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http, ObjectMapper objectMapper) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/inventory/**").hasAnyAuthority(READ_AUTHORITIES)
                        .requestMatchers(HttpMethod.POST, "/api/inventory/**").hasAnyAuthority(WRITE_AUTHORITIES)
                        .requestMatchers(HttpMethod.PUT, "/api/inventory/**").hasAnyAuthority(WRITE_AUTHORITIES)
                        .requestMatchers("/api/inventory/**").denyAll()
